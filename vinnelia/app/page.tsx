...
function LandingContent() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="font-poppins text-lg md:text-xl tracking-widest opacity-70 mb-8">THE WEDDING OF</p>
        ...
        {guestName && (
          <div className="mt-12 text-center text-white italic space-y-1">
            ...
            <p className="text-base md:text-lg"> kami mengundang anda untuk menghadiri acara pernikahan kami</p>
          </div>
        )}
      </motion.div>
      ...
      <Link
        ...
        className="mt-8 px-12 py-3 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold shadow-xl hover:scale-105 transition-transform"
      >
        Buka Undangan
      </Link>

      <footer className="absolute bottom-4 w-full text-center text-white opacity-50">
        <p className="text-xs">&copy; 2025 Kevin & Theresia. All rights reserved.</p>
      </footer>
    </main>
  );
}
